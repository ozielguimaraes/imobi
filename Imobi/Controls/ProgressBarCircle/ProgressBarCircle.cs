...
namespace Imobi.Controls.ProgressBarCircle
{
    public class ProgressBarCircle : ProgressBar
        {
            #region Properties
            ...
            public static readonly BindableProperty AnimationLengthProperty = BindableProperty.Create("AnimationLength", typeof(uint),
                                                                                                      typeof(ProgressBarCircle), (uint)800,
            ...
            public static readonly BindableProperty AnimationEasingProperty = BindableProperty.Create("AnimationEasing", typeof(uint),
                                                                                                      typeof(ProgressBarCircle), (uint)0,
            ...
            public Easing AnimationEasing
            {
                get
                {
                    ...
                    var easingMethod = ProgressBarCircleUtils.IntToEasingMethod((int)intValue);

                    return easingMethod;
                }
                set
                {
                    var easingMethod = ProgressBarCircleUtils.EasingMethodToInt(value);
            ...
            public static readonly BindableProperty RingProgressColorProperty = BindableProperty.Create("RingProgressColor", typeof(Color),
                                                                                                        typeof(ProgressBarCircle), Color.FromRgb(234, 105, 92));
            ...
            public static readonly BindableProperty RingBaseColorProperty = BindableProperty.Create("RingBaseColor", typeof(Color),
                                                                                                    typeof(ProgressBarCircle), Color.FromRgb(46, 60, 76));
            ...
            {
                var progress = (ProgressBarCircle)bindable;
            ...
            {
                var ProgressBarCircle = (ProgressBarCircle)bindable;

                var animationIsRunning = ProgressBarCircle.AnimationIsRunning("Progress");

                // If the progress animation is already running
                // rerun it with the new length value.
                if (animationIsRunning)
                    ProgressBarCircle.StartProgressToAnimation();
            }
